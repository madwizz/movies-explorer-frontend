    ...
    <section className='portfolio'>
      ...
      <ul className='about-me__links'>
        <li className='about-me___link'>
          <a href='https://madwizz.github.io/how-to-learn/' target='_blank' rel='noreferrer noopener' className='about-me__link-text'>Статичный сайт</a>
        ...
        <li className='about-me___link'>
          <a href='https://madwizz.github.io/russian-travel/' target='_blank' rel='noreferrer noopener' className='about-me__link-text'>Адаптивный сайт</a>
          <a href='https://madwizz.github.io/russian-travel/' target='_blank' rel='noreferrer noopener'>
            <img className='about-me__link-arrow' src={arrowPic} alt='Arrow pic'/>
          </a>
        </li>
        <li className='about-me___link'>
          <a href='https://madwizz.github.io/mesto/' target='_blank' rel='noreferrer noopener' className='about-me__link-text'>Одностраничное приложение</a>
